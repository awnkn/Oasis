    ...
    >
      ...
      >
        ...
        <form onSubmit={submit} className="mt-5 space-y-4">
          <div>
            <label htmlFor="mb-name" className="mb-1 block text-xs font-medium text-ink-muted">
              Guest name
            </label>
            <input
              id="mb-name"
          ...
          <div>
            <label htmlFor="mb-phone" className="mb-1 block text-xs font-medium text-ink-muted">
              Phone (WhatsApp)
            </label>
          ...
          <div>
            <label htmlFor="mb-email" className="mb-1 block text-xs font-medium text-ink-muted">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label htmlFor="mb-date" className="mb-1 block text-xs font-medium text-ink-muted">
                Day
              </label>
              <input
                id="mb-date"
            ...
            <div>
              <label htmlFor="mb-guests" className="mb-1 block text-xs font-medium text-ink-muted">
                Guests
              </label>
              <input
                id="mb-guests"
          ...
          <div>
            <label htmlFor="mb-notes" className="mb-1 block text-xs font-medium text-ink-muted">
          ...
          <div className="flex items-center justify-between border-t border-line-soft pt-4">
            <p className="text-sm text-ink-muted">
              ...
              <span className="text-xs text-ink-subtle">payable at the gate</span>
            </p>
            <button
              type="submit"
              disabled={busy}

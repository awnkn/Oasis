      ...
      >
        <div className="flex items-start justify-between">
          ...
          <button
            onClick={onClose}
            aria-label="Close"
            className="rounded-full p-1.5 text-ink-subtle transition hover:bg-surface-muted hover:text-ink"
          >
        ...
        <form onSubmit={submit} className="mt-5 space-y-4">
          <div>
            <label htmlFor="eb-name" className="mb-1 block text-xs font-medium text-ink-muted">
              Guest name
            </label>
            <input
              id="eb-name"
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label htmlFor="eb-phone" className="mb-1 block text-xs font-medium text-ink-muted">
                Phone
              </label>
              <input
                id="eb-phone"
            ...
            <div>
              <label htmlFor="eb-email" className="mb-1 block text-xs font-medium text-ink-muted">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label htmlFor="eb-date" className="mb-1 block text-xs font-medium text-ink-muted">
                Day
              </label>
              <input
                id="eb-date"
            ...
            <div>
              <label htmlFor="eb-guests" className="mb-1 block text-xs font-medium text-ink-muted">
                Guests
              </label>
              <input
                id="eb-guests"
          ...
          <div>
            <label htmlFor="eb-heard" className="mb-1 block text-xs font-medium text-ink-muted">
          ...
          <div>
            <label htmlFor="eb-notes" className="mb-1 block text-xs font-medium text-ink-muted">
          ...
          {error && (
            <p role="alert" className="rounded-xl border border-status-critical/30 bg-status-critical-tint px-4 py-3 text-sm text-status-critical">{error}</p>
          )}
          ...
          <div className="flex items-center justify-end gap-3 border-t border-line-soft pt-4">
            <button
              type="button"
              onClick={onClose}
              className="rounded-full border border-oasis-950/10 px-5 py-2.5 text-sm font-medium text-ink-muted transition hover:bg-surface-sunken"
            >
              Cancel
            </button>
            <button
